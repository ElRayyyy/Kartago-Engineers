            ...
            try:
                ...
                if gameId in games:
                    ...
                    if data != "get":
                        ...
                        if timePlayer < 0:
                            handle_game_end(game, "Timeout", conn, fileLog, timePlayer, 1-p)
                            break
                        ...
                        if not game.valid:
                            ...
                            handle_game_end(game, "Invalid Move", conn, fileLog, timePlayer, 1-p)
                            break
                        ...
                        if game.win is not None:
                            ...
                            handle_game_end(game, "win", conn, fileLog, timePlayer, p)
                            break
