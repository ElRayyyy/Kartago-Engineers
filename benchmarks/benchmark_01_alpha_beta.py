...
try:
    from alpha_beta_ki import transposition_table
except ImportError:
    transposition_table = None

try:
    from alpha_beta_ki import nodes_visited
except ImportError:
    nodes_visited = None
...
def benchmark(fen_str: str, max_depth: int = 4):
    ...
    for depth in range(1, max_depth + 1):
        ...
        if nodes_visited is not None:
            print(f"  Zustände: {alpha_beta_ki.nodes_visited}")
